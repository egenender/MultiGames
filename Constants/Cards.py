...
comandos = { 
    ...
    "lose_camp" : {
        ...
        "indicacion_argumentos" : ["Explorador Campero (-1 vida)", "Explorador Brujula (-2 vidas)", "Explorador Hoja (-2 vidas)", "Usar carta skill"]
    },
    "lose_leaf" : {
        "tipo" : "indicaciones",
        "comando" : "command_lose_leaf",
        "indicacion" : "Elija que quiere hacer",
        "indicacion_argumentos" : ["Explorador Campero (- 2 vidas)", "Explorador Brujula (-2 vidas)", "Explorador Hoja (-1 vida)", "Usar carta skill"]
    },
    "lose_compass" : {
        "tipo" : "indicaciones",
        "comando" : "command_lose_compass",
        "indicacion" : "Elija que quiere hacer",
        "indicacion_argumentos" : ["Explorador Campero (- 2 vidas)", "Explorador Brujula (- 1 vida)", "Explorador Hoja -2 vidas)", "Usar carta skill"]
    },
    "lose_bullet" : {
