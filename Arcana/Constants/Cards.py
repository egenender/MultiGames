...
ARCANACARDS = [ 
 ...
 },
 {
   ...
   "Título reverso": "+1",
   "Texto reverso": "Antes de jugar el destino, el jugador activo puede descartar esta carta para tratar el destino no jugado como si fuera 1 más alto durante este turno.",
   "Legal": lambda kept, played: ((not (played in [2,4,6] and kept in [2,4,6])) and ((played in [1,3,5,7] and kept in [1,3,5,7] and played > kept) or (kept < played)) or 
   	((not (kept in [2,4,6] and played in [2,4,6])) and ((kept in [1,3,5,7] and played in [1,3,5,7] and kept > played) or (played < kept)))
 },
 {
   "Título": "±1",
